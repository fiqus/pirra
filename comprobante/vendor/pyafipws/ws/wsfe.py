...
from .soap import SimpleXMLElement, SoapClient
...
def aut(client, token, sign, cuit, id, tipo_doc=80, nro_doc=23111111113,
    ...
    presta_serv = 0, fecha_serv_desde=None, fecha_serv_hasta=None, ult_nro=None, **kwargs ):
    ...
    return dict(cae=cae, fecha_vto=fecha_vto, resultado=resultado,
                motivo=motivo, reproceso=reproceso, ult_nro=ult_nro)
