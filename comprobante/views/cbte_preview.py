...
class ComprobantePreview(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        if 'pk' in self.kwargs:
            ...
            context['importe_neto_gravado'] = comprobante.importe_neto_gravado
            context['importe_no_gravado'] = comprobante.importe_no_gravado
            context['importe_exento'] = comprobante.importe_exento
            context['importe_descuento'] = importe_descuento
